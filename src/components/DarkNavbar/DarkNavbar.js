...
export default function DarkNavbar({language, setLanguage}) {
  ...
  return (
    <nav className="fixed top-0 bg-primary-1 bg-opacity-90 absolute w-full z-50"> {/* change fixed */}
      <div className="w-full mx-auto px-8">
        <div className="flex justify-between">
          <div className="flex space-x-7">
            <div>
              <a href="/" className="flex items-center py-4 px-2">
                <span className="font-semibold font-playfair text-white text-lg hover:text-primary-4 transition duration-300">Au Coeur de l'Aa</span>
              </a>
            </div>
          </div>
